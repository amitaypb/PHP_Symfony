...
return [
    ...
    [ // $staticRoutes
        ...
        '/store/product-categories-select' => [[['_route' => 'product_categories_select', '_controller' => 'App\\Controller\\StoreController::getProductCategories'], null, null, null, false, false, null]],
    ],
    [ // $regexpList
        0 => '{^(?'
                .'|/_(?'
